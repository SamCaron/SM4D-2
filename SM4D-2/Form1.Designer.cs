namespace SM4D_2
{
    partial class AccueilBorne
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AccueilBorne));
            panelRubanGauche = new Panel();
            label1 = new Label();
            button4 = new Button();
            labelReglages = new Label();
            buttonReglages = new Button();
            labelLieux = new Label();
            buttonCollections = new Button();
            labelMedias = new Label();
            buttonMedias = new Button();
            panelCentreNiveau1 = new Panel();
            ...
            // panelRubanGauche
            // 
            panelRubanGauche.Controls.Add(label1);
            panelRubanGauche.Controls.Add(button4);
            panelRubanGauche.Controls.Add(labelReglages);
            panelRubanGauche.Controls.Add(buttonReglages);
            panelRubanGauche.Controls.Add(labelLieux);
            panelRubanGauche.Controls.Add(buttonCollections);
            ...
            button1.Location = new Point(524, 569);
            ...
            button2.Location = new Point(473, 569);
            button2.Name = "button2";
            button2.Size = new Size(41, 31);
            button2.TabIndex = 21;
            ...
            button3.Location = new Point(425, 569);
            ...
            panelRubanGauche.PerformLayout();
            panelCentreNiveau1.ResumeLayout(false);
        ...
        #endregion
        private Panel panelRubanGauche;
        private Panel panelCentreNiveau1;
        ...
        private Label labelLieux;
        private Label labelReglages;
